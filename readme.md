...
**Needs: branching, rebasing, forking, pull requests
Tutorials:
https://www.codecademy.com/learn/learn-git
https://learngitbranching.js.org/
https://www.atlassian.com/git/tutorials/comparing-workflows
Project: HTML/CSS site with branching (Assignments: Collaboration Workshop, building the Cookie project from CTP: https://github.com/CUNYTechPrep/week-01-projects)
Independent: Group students by companies, begin research for first 5-min presentation, stand up about progress

Day 3
Javascript: Syntax, Overview, Objects
Mini project: Programming problems (eloquent JS?)
DOM manipulation + mini project

Day 4
Advanced Javascript + Jquery + Ajax


Day 5
Intro to server side (node, flask, ruby, etc)
...
Day 11
TDD Lesson: Mocha (CTP repo has testing lecture and project)

Day 12
Intro to ECMAScript and Babel(?)
...
Day 14
React project + independent deep dive tutorials
